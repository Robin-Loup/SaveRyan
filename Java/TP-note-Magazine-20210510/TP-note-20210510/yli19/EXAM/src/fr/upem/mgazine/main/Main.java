...
public class Main {
	public static void main(String[] args) {
		...
		*/
	    ...
	    System.out.println(unlikeEval.score());  // -5
	    
	    magazine1.addEval(starEval);
	    magazine1.addEval(likeEval);
	    System.out.println(magazine1.averageScore());  // 30.0
	    /*
	    almanac1.addEval(starEval);
	    almanac1.addEval(likeEval);
	    System.out.println(almanac1.averageScore());  // 30.0
	    */
