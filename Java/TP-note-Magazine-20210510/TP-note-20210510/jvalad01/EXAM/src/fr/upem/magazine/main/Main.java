...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println(magazineList.contains(new Magazine("newsweek", 0))); //
		// true
		System.out.println(magazineList.contains(new Magazine("newswoke", 0))); //
		// false

		var magazineSet = new HashSet<>(magazineList);
		System.out.println(magazineSet.contains(new Magazine("newsweek", 0)));
